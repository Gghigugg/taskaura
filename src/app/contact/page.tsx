      ...
      <div className="container" style={{ maxWidth: 680, paddingTop: 70 }}>
        ...
        <section className="card" style={{ marginTop: 28 }}>
          ...
          <p style={{ color: "var(--muted)", lineHeight: 1.7 }}>
            Need an assisted account, payment confirmation, task support or account help? Contact the Taskora admin. Contact details will be configured from the Admin Settings system.
          </p>
